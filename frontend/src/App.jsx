      ...
      <div className="flex-grow grid grid-cols-1 md:grid-cols-3 gap-6 overflow-hidden mb-4 min-h-0">
        ...
        <div className="md:col-span-1 flex flex-col h-full overflow-hidden min-h-0 space-y-4">
          ...
          <div className="flex-grow flex flex-col justify-between overflow-hidden min-h-0 space-y-4">
            ...
            {/* Branding Footer */}
            <div className="border-t border-slate-800/80 pt-4 mt-2 shrink-0 flex flex-col items-center justify-center space-y-2 text-center">
              <p className="text-amber-500 font-bold text-sm tracking-wide flex items-center justify-center gap-1.5">
                Never miss your next win. <span>✌️</span>
              </p>
              <div className="flex items-center gap-3.5 text-slate-400">
                <a href="https://github.com/DhryXpert" target="_blank" rel="noopener noreferrer" className="hover:text-slate-200 transition-colors">
                ...
                <a href="mailto:dhairyakhatri82@gmail.com" className="hover:text-slate-200 transition-colors">
                  <svg className="h-5 w-5 fill-none stroke-current" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
              ...
              <div className="space-y-0.5">
                <p className="text-sky-400 hover:text-sky-300 transition-colors text-xs font-semibold">
