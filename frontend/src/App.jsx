    ...
    <div className="gradient-bg h-screen w-screen flex flex-col justify-between p-6 overflow-hidden">
      ...
      <header className="flex items-center justify-between border-b border-slate-900 pb-3 mb-4 shrink-0">
        <div className="flex items-center gap-3">
          <img src="/icons8-ai-32.png" alt="Veritas AI Logo" className="w-8 h-8 object-contain" />
      ...
      <div className="flex-grow grid grid-cols-1 md:grid-cols-3 gap-6 overflow-hidden mb-4 min-h-0">
        ...
        <div className="md:col-span-1 flex flex-col h-full overflow-hidden min-h-0 space-y-4">
          ...
          <div className="flex-grow flex flex-col justify-between overflow-hidden min-h-0 space-y-4">
            ...
            <div className="glass-panel p-4 shrink-0 flex flex-col items-center justify-center space-y-3.5 text-center border border-slate-800/60 bg-slate-950/40 rounded-2xl">
              <p className="text-slate-400 text-xs font-medium tracking-wide">
                Trained on the Fake and Real News Dataset (Kaggle, ~44,900 articles) using TF-IDF + Logistic Regression &mdash; 99.4% test accuracy, 0.9996 ROC-AUC.
              </p>
              
              <div className="flex flex-wrap items-center justify-center gap-3 text-[11px] text-slate-400">
                <span className="font-semibold text-slate-500">
                  Built with 🤍 by <span className="text-slate-300">Dhairya</span>
                </span>
                <span className="text-slate-800 hidden sm:inline">&middot;</span>
                
                <div className="flex flex-wrap items-center justify-center gap-2">
                  <a
                    href="https://github.com/DhryXpert/fake-news-detection-nlp"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg border border-slate-800 bg-slate-900/50 hover:bg-slate-850 hover:border-slate-700/80 hover:text-teal-400 text-slate-300 transition-all duration-300 active:scale-95 shadow-sm"
                  >
                  ...
                  <a
                    ...
                    className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg border border-slate-800 bg-slate-900/50 hover:bg-slate-850 hover:border-slate-700/80 hover:text-teal-400 text-slate-300 transition-all duration-300 active:scale-95 shadow-sm"
                  >
                    <svg className="h-3.5 w-3.5 fill-none stroke-current" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <a
                    ...
                    className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg border border-slate-800 bg-slate-900/50 hover:bg-slate-850 hover:border-slate-700/80 hover:text-teal-400 text-slate-300 transition-all duration-300 active:scale-95 shadow-sm"
                  >
                    <svg className="h-3.5 w-3.5 fill-none stroke-current" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
